...
/**
 * JUnit test of ArrayListSorted
 * @author Kaiyaun Shi, Monika
 * @version Autumn 2016
 */
public class ArrayListSortedTest {
	...
	public final void arrayContain205HT() {
		...
		assertTrue("contain 205 head true fail", al.contains("str000"));
	}
	...
	public final void getIndex205Head() {
		...
		assertEquals("get 205 index head fail", 0, al.getIndex("str000"));	
	}
	...
	public final void get205Head() {
		...
		assertEquals("get 205 head fail", "str000", al.get(0));
	}
	...
	public final void iteratorRemove() {
		...
		String testStr = "[str000";
		for (int i = 1; i < 204; i++) {
			if(i < 10){
				al.insert("str" + '0' + '0' + i);
				
			}else if(i>9 && i < 100 && i != 101){
				al.insert("str"+'0'+ i);
		...
		assertEquals("iterator remove fail", testStr, str);
	}
}
